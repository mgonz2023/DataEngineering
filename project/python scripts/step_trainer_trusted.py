...
AmazonS3_node1678229312126 = glueContext.create_dynamic_frame.from_catalog(
    database="marcos",
    table_name="customer_curated",
    transformation_ctx="AmazonS3_node1678229312126",
)
...
Join_node1678229375601 = Join.apply(
    frame1=AmazonS3_node1678229312126,
    frame2=S3bucket_node1,
    keys1=["serialnumber"],
    keys2=["serialNumber"],
    transformation_ctx="Join_node1678229375601",
)

# Script generated for node ApplyMapping
ApplyMapping_node2 = ApplyMapping.apply(
    frame=Join_node1678229375601,
    mappings=[
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://marcos-data-lake-house/step_trainer/trusted/",
        "partitionKeys": [],
    },
